...
<div class="admin-form-wrapper" style="background: linear-gradient(135deg, #7c3aed 0%, #a78bfa 100%); min-height: 100vh; padding-top: 40px; padding-bottom: 40px;">
    <div class="admin-form-card">
        <div class="form-header">
            <h1 class="admin-form-title">Editar Noticia</h1>
            <p class="form-subtitle">Actualiza la información de la noticia "{{ $news->title }}"</p>
        </div>
        ...
        <form action="{{ route('admin.news.update', $news) }}" method="POST" enctype="multipart/form-data" class="news-form">
            @method('PUT')
